...
private fun ArticleCard(title: String,
    ...
    Column(modifier = modifier) {
        ...
        Text(text = shortDescription, modifier = Modifier.padding(start = 16.dp, end = 16.dp), textAlign = TextAlign.Justify)
...
fun ComposeArticleApp() {
    ArticleCard(
        ...
        longDescription = stringResource(R.string.jetpack_full_description),
